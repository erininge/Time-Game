(() => {
  ...
  function jpTimeStrings(h24, m) {
    ...
    const accept = new Set([
      ...
      norm(`${ampmKana}${coreKanji}`),
    ]);

    return {
      displayKanji: fullKanji,
      displayKana: Array.from(fullKanaVariants)[0],
      acceptSet: accept,
      expected: { fullKanji, fullKana: Array.from(fullKanaVariants)[0] }
    };
  }
